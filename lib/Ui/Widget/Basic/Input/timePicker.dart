...
class _TimeInputXState extends State<TimeInputX> {
  ...
  void initState() {
    super.initState();
    _hours =
        widget.initialTime?.hourOfPeriod ?? 1; // إذا كانت الساعة 0 يتم تعيين 1
    _minutes = widget.initialTime?.minute ?? 0;
    _amPm = widget.initialTime != null
        ? (widget.initialTime?.period == DayPeriod.am ? 'AM' : 'PM')
        : 'AM';
  }
