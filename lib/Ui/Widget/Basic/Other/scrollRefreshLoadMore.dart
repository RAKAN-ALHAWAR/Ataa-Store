...
import 'package:ataa/UI/GeneralState/error.dart';
import 'package:ataa/Ui/Widget/Basic/Other/prototypeHeight.dart';
...
class ScrollRefreshLoadMoreXState<T> extends State<ScrollRefreshLoadMoreX<T>> {
  ...
  ScrollPhysics get physics => widget.isScrollEnabled
          ...
          return Container(
            ...
            child: SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: widget.errorWidget?.call(error!.message) ??
                    ErrorView(
                      error: error!,
        ...
        child: ConstrainedBox(
          ...
          child: Align(
            alignment: widget.isEmptySearchCenter
                ? Alignment.center
                : Alignment.topCenter,
            child: widget.emptySearch ??
                EmptyView(
                  message: widget.emptySearchMessage ??
    ...
    if (widget.scrollDirection == Axis.horizontal) {
      return Padding(
        padding: EdgeInsets.only(
            top: widget.padding?.top ?? 0, bottom: widget.padding?.bottom ?? 0),
      ...
      itemBuilder: (context, index) {
        ...
        return widget.itemBuilder(
            items[widget.isScrollingHeader && widget.header != null
                ? index - 1
                : index],
            widget.isScrollingHeader && widget.header != null
                ? index - 1
                : index);
      },
    );
